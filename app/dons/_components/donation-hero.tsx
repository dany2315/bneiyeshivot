    ...
    <section className="border-b border-[var(--border)] bg-white">
      <div className="container grid gap-8 py-10 sm:gap-10 sm:py-14 lg:grid-cols-[minmax(0,1fr)_440px] lg:items-center lg:py-20">
        <div className="grid max-w-3xl gap-6">
          ...
          <a
            className="group relative grid aspect-video min-h-52 overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--primary)] shadow-[0_20px_50px_rgba(6,40,70,0.14)] sm:min-h-72 sm:rounded-2xl lg:hidden"
        ...
        <a
          className="group relative hidden aspect-video min-h-52 overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--primary)] shadow-[0_20px_50px_rgba(6,40,70,0.14)] sm:min-h-72 sm:rounded-2xl lg:grid lg:aspect-[4/5] lg:shadow-[0_28px_80px_rgba(6,40,70,0.16)]"
          href="https://www.youtube.com/@bneiyeshivot"
          rel="noreferrer"
          target="_blank"
        >
